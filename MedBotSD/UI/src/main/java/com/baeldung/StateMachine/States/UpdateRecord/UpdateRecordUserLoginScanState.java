...
public class UpdateRecordUserLoginScanState extends State {
    private Logger logger;

    public UpdateRecordUserLoginScanState(Logger logger) { this.logger = logger; }
        ...
        if (update.hasMessage() && update.getMessage().hasText() && update.getMessage().getText().equals("/start")) {
            ...
            if (tmpUser == null) {
                ...
                if (doctorsList == null) {
                    ...
                    return enumStates.UPDATE_RECORD_DOCTOR_ID_SCAN_STATE;
                }
            }
        }
