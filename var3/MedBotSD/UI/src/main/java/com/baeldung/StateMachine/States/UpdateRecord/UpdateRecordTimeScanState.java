...
public class UpdateRecordTimeScanState extends State {
    private Logger logger;

    public UpdateRecordTimeScanState(Logger logger) { this.logger = logger; }
    ...
    public int updateHandler(int state, EnumStates enumStates, Update update, User user, User userTmp, Doctor doctorTmp,
        ...
        if (setTimeFlag) {
            ...
            if (flag) {
                recordView.getRecordSuccessMessage(update);
                recordView.newDataInputMessage(update);
                recordView.recordDateInputMessage(update);
                return enumStates.UPDATE_RECORD_NEW_DATE_SCAN_STATE;
            }
            else {
                recordView.getRecordErrorMessage(update);
